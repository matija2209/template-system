...
// Create direct access to template types for easier imports
const templatesJsContent = `// Re-export template types from dist for easier imports
export * from './dist/types/templates.js';
`;

const templatesDtsContent = `// Re-export template types from dist for easier imports
...
fs.writeFileSync(
  path.join(__dirname, "..", "templates.d.ts"),
  templatesDtsContent
);
