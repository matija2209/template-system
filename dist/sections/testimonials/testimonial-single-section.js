...
export const TestimonialSingleSection = ({ testimonials, id, sectionClasses, headingClasses, subtitleClasses, customStyles, title, subtitle, }) => {
    ...
    return (_jsxs("section", { id: id, className: twMerge('testimonials-gradient py-16 text-white bg-primary', sectionClasses?.replaceAll(",", " ")), children: [_jsxs("div", { className: "container mx-auto px-4", children: [_jsxs("div", { className: "mb-12", children: [title && _jsx("h2", { className: twMerge("text-3xl font-bold text-center mb-2", headingClasses?.replaceAll(",", " ")), children: title }), subtitle && _jsx("p", { className: twMerge("text-lg text-center mb-12", subtitleClasses?.replaceAll(",", " ")), children: subtitle })] }), _jsxs("div", { className: "relative overflow-hidden", onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, ref: testimonialRef, children: [_jsx("button", { onClick: handlePrev, className: "arrow-button border rounded-full absolute left-0 top-1/2 transform -translate-y-1/2 bg-opacity-20 text-white p-2  z-10 hover:bg-opacity-30 transition-all nav-arrow", "aria-label": "Previous testimonial", children: _jsx("svg", { className: "arrow-icon w-6 h-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M15 19l-7-7 7-7" }) }) }), _jsx("div", { className: "relative h-[250px] testimonials-container", children: testimonials.map((testimonial, index) => (_jsx(TestimonialCard, { testimonial: testimonial, isActive: index === activeIndex }, testimonial.id || index))) }), _jsx("button", { onClick: handleNext, className: "arrow-button border  absolute right-0 top-1/2 transform -translate-y-1/2 bg-opacity-20 text-white p-2 rounded-full z-10 hover:bg-opacity-30 transition-all nav-arrow", "aria-label": "Next testimonial", children: _jsx("svg", { className: "arrow-icon w-6 h-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M9 5l7 7-7 7" }) }) })] }), renderPaginationDots()] }), _jsx("style", { dangerouslySetInnerHTML: {
                    __html: `
      ...
      `
                } }), customStyles && _jsx("style", { dangerouslySetInnerHTML: { __html: customStyles } })] }));
};
