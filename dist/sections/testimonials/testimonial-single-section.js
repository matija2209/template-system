...
const TestimonialCard = ({ testimonial, isActive }) => {
    ...
    return (_jsxs("div", { className: `testimonial-card max-w-lg mx-auto p-6 text-center transition-opacity duration-500 ${isActive ? 'opacity-100' : 'opacity-0 absolute top-0 left-0 right-0'} ${testimonial.customClasses || ''}`, children: [renderStars(testimonial.rating), _jsxs("p", { className: "text-center mb-4 italic font-light", children: ["\"", testimonial.text, "\""] }), _jsx("p", { className: "font-semibold", children: testimonial.name }), _jsx("p", { className: "text-sm text-gray-600", children: formatDate(testimonial.date) })] }));
};
