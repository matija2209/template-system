...
export const ContactModernSection = ({ email, phone, address, socialLinks, mapUrl, id, className = '', title = 'Get in touch', subtitle = "We'd love to hear from you. Fill in the form and we'll get back to you shortly.", formEndpoint, openingTimes, emergencyOpeningTimes, openingTimesCustom, }) => {
