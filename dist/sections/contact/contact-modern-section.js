...
export const ContactModernSection = ({ email, phone, address, socialLinks, excludeSection, form, includeAddress, includeEmail, includeEmergencyOpeningTimes, includeOpeningTimes, includePhone, includeMap, includeForm, action, subtitleClasses, customStyles, sectionTemplate, sectionClasses, googlePlaceId, extraBlocks, design, contentClasses, type, id, visibility, title = 'Get in Touch', subtitle, openingTimes, emergencyOpeningTimes, openingTimesCustom, headingClasses }) => {
