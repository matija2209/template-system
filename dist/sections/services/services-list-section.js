...
export const ServicesListSection = ({ services, id, ImageComponent, cta, excludeSection, includeServices, subtitle, title, type, contentClasses, extraBlocks, headingClasses, sectionClasses, sectionTemplate, subtitleClasses, }) => {
