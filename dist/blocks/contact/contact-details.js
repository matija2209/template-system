...
const ContactDetails = ({ email, phone, address, socialLinks, excludeSection, formId, includeAddress, includeEmail, includeEmergencyOpeningTimes, includeOpeningTimes, includePhone, includeMap, includeForm, action, subtitleClasses, sectionTemplate, sectionClasses, googlePlaceId, extraBlocks, contentClasses, type, id, title = 'Get in Touch', visibility, openingTimes, emergencyOpeningTimes, openingTimesCustom, headingClasses }) => {
    ...
    return (_jsxs("div", { className: "space-y-2", children: [includeAddress && address ? (_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(MapPin, { className: "text-white rounded-full p-2 bg-black text-4xl" }), address] })) : null, includeEmail && email ? (_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Mail, { className: "text-white rounded-full p-2 bg-black text-4xl" }), " ", _jsx("a", { href: `mailto:${email}`, className: "text-white", children: email })] })) : null, includePhone && phone ? (_jsx("div", { className: "flex items-center gap-2", children: phone.split(",").map((phoneNumber, index) => {
                    return (_jsxs("div", { className: "w-full flex flex-column gap-2 items-center", children: [_jsx(Phone, { className: "text-white rounded-full p-2 bg-black text-4xl" }), " ", _jsxs("a", { href: `tel:${phoneNumber.trim()}`, className: "text-white", children: [" ", formattedPhone || phoneNumber.trim()] })] }, index));
                    ...
                    return (_jsx("a", { href: link.url, target: "_blank", rel: "noopener noreferrer", className: "text-white", children: _jsx(SocialIcon, {}) }, index));
                }) }))] }));
};
