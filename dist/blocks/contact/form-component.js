...
const FormComponent = ({ form: formConfig, headingClasses, }) => {
    ...
    return (_jsx(_Fragment, { children: _jsx(Form, { ...form, children: _jsxs("form", { onSubmit: form.handleSubmit(onSubmit), className: "space-y-6", children: [fields && fields.map((field) => {
                        ...
                        return (_jsx(FormField, { control: form.control, name: field.name, render: ({ field: formField }) => (_jsxs(FormItem, { children: [_jsx(FormControl, { children: isMessageField ? (_jsx(Textarea, { ...formField, rows: 4, placeholder: field.placeholder, className: twMerge("border p-2 w-full form-textarea") })) : (_jsx(Input, { ...formField, type: field.type, placeholder: field.placeholder, className: twMerge("border p-2 w-full form-input") })) }), _jsx(FormMessage, {})] })) }, field.name));
                    }), _jsx(Button, { type: "submit", className: "form-btn-submit w-full", disabled: loading, children: loading ? _jsx(Spinner, {}) : "Nachricht Senden" })] }) }) }));
};
