...
const TestimonialCardVariantOne = (props) => {
    ...
    return (_jsxs("article", { className: twMerge("bg-white flex flex-col p-6 rounded-sm shadow-md space-y-4 w-full justify-between", "h-full", // Ensure consistent height
        ...
        }, children: [_jsxs("div", { className: "space-y-4 flex-grow", children: [_jsx("div", { className: twMerge("flex self-start", "text-orange-400"), children: [...Array(5)].map((_, i) => (_jsx(Star, { className: i < (testimonial.rating || 0) ? "text-orange-400" : "text-gray-300", fill: i < (testimonial.rating || 0) ? "currentColor" : "none" }, i))) }), _jsxs("div", { className: "space-y-2", children: [_jsx(Quote, { className: "text-3xl text-primary" }), _jsxs("p", { className: twMerge("self-start text-left text-lg"), children: [isExpanded || testimonial.text.length <= (isMobile ? 150 : 300)
                                        ? testimonial.text
