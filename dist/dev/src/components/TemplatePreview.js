    ...
    const renderTemplate = () => {
        switch (templateType) {
            case 'basic-service-card':
                return (_jsxs("div", { className: "template-container", children: [_jsx("h2", { className: "template-title", children: "BasicServiceCard Component" }), _jsx("div", { className: "component-preview", children: _jsx("div", { className: "tailwind-reset", children: _jsx(BasicServiceCard, { service: sampleService, ImageComponent: CustomImage }) }) }), _jsxs("div", { className: "component-code", children: [_jsx("h3", { children: "Component Usage:" }), _jsx("pre", { children: `<BasicServiceCard 
  service={service}
  ImageComponent={ImageComponent}
/>` })] })] }));
            case 'simple-list-service-card':
                return (_jsxs("div", { className: "template-container", children: [_jsx("h2", { className: "template-title", children: "SimpleListServiceCard Component" }), _jsx("div", { className: "component-preview", children: _jsx("div", { className: "tailwind-reset", children: _jsx(SimpleListServiceCard, { service: sampleService, ImageComponent: CustomImage }) }) }), _jsxs("div", { className: "component-code", children: [_jsx("h3", { children: "Component Usage:" }), _jsx("pre", { children: `<SimpleListServiceCard 
  service={service}
  ImageComponent={ImageComponent}
/>` })] })] }));
            default:
